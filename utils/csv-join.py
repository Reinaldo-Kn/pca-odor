...
df_1_atual_df = os.path.join(dataset_patch,'4-Perfil_Racao.csv')
df_1 = pd.read_csv(df_1_atual_df)
df_2_atual_df = os.path.join(dataset_patch,'6-Perfil_Racao.csv')
df_2 = pd.read_csv(df_2_atual_df)
df_3_atual_df = os.path.join(dataset_patch,'7-Perfil_Compostagem(meio).csv')
df_3 = pd.read_csv(df_3_atual_df)
df_4_atual_df = os.path.join(dataset_patch,'10-Perfil_Compostagem(meio).csv')
